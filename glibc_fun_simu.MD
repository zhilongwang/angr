...
class __isoc99_scanf(FormatParser):
 ...
        fmt_str = self._parse(0)
  ...
  ```
  link:
  ###### [FormatParser._parse()](https://github.com/njuwangzhilong/angr/blob/master/AngrCodeRead/FormatString.MD#_parse) 
